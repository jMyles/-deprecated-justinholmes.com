poapProxyABI = [{
    ...
    "constant": false,
    "inputs": [{"name": "eventId", "type": "uint256"}, {"name": "account", "type": "address"}],
    ...
    "constant": false,
    "inputs": [{"name": "newLastId", "type": "uint256"}],
    "name": "setLastId",
    "outputs": [],
    "payable": false,
    "stateMutability": "nonpayable",
    ...
    "constant": false,
    "inputs": [{"name": "eventId", "type": "uint256"}, {"name": "to", "type": "address[]"}],
    ...
    "outputs": [{"name": "tokenId", "type": "uint256"}, {"name": "eventId", "type": "uint256"}],
    "payable": false,
    "stateMutability": "view",
    "type": "function"
}, {
    ...
    "constant": false,
    "inputs": [{"name": "__name", "type": "string"}, {"name": "__symbol", "type": "string"}, {
        "name": "__baseURI",
        "type": "string"
    ...
    "constant": false,
    "inputs": [{"name": "eventIds", "type": "uint256[]"}, {"name": "to", "type": "address"}],
    ...
    "anonymous": false,
    "inputs": [{"indexed": true, "name": "eventId", "type": "uint256"}, {
        "indexed": false,
        "name": "tokenId",
        "type": "uint256"
    }],
