...
let ethbcnEID = 95423;
let devconEID = 95424;
export async function checkPoap(eventIDs) {
...
export async function connect() {
    ...
    let networkChangeResult = networkChange.then(function (result) {
        console.log("Network change went OK.");
    }, function (exception) {
        if (exception.code == 4902) {
            let networkAddition = window.ethereum.request({
            ...
            networkAddition.then(function (result) {
